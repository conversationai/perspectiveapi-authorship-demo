...
@Component({
  selector: 'checker-status',
  template: require('./checker-status.component.html'),
  styles: [require('./checker-status.component.css'), require('./common.css')],
})

@Injectable()
export class CheckerStatus implements OnChanges {
  ...
  private isPlayingLoadingAnimation: boolean = false;
  private isPlayingShowOrHideDetailsAnimation: boolean = false;
  ...
  private layersAnimating: boolean = false;
